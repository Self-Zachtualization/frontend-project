        ...
        function (a, b) {
            ...
            (f.packs = d),
              ...
              (f.load = function (a) {
                ...
                for (var c in a.instruments)
                  a.instruments.hasOwnProperty(c) &&
                    (b[c] = f.createInstrument(a.instruments[c].name, a.instruments[c].pack));
                for (var d in a.notes)
                  if (a.notes.hasOwnProperty(d))
                    for (var e = -1; ++e < a.notes[d].length; ) {
                      ...
                      if ("string" == typeof g) {
                        var h = g.split("|");
                        "rest" === h[1] ? b[d].rest(h[0]) : b[d].note(h[0], h[1], h[2]);
                      } else
                        "rest" === g.type
                          ? b[d].rest(g.rhythm)
                          : "note" === g.type && b[d].note(g.rhythm, g.pitch, g.tie);
                    }
                return f.finish();
              }),
              ...
              (f.setMasterVolume = function (a) {
                a > 1 && (a /= 100),
                  ...
                  f.masterVolume.gain.setValueAtTime(a, f.audioContext.currentTime);
              }),
              (f.getTotalSeconds = function () {
                return Math.round(f.totalDuration);
              }),
              (f.setTickerCallback = function (a) {
                if ("function" != typeof a) throw new Error("Ticker must be a function.");
              ...
              (f.setTempo = function (a) {
                (f.tempo = 60 / a), e && (e.resetTempo(), f.onDurationChangeCallback());
              }),
          ...
          c.loadPack = function (a, b, c) {
            ...
            if ("undefined" != typeof d[a][b])
              throw new Error(
                "A(n) " + a + ' pack with the name "' + b + '" has already been loaded.'
              );
            d[a][b] = c;
          };
        },
      ...
      3: [
        function (a, b) {
          function c(a, b) {
            ...
            if (-1 === f.indexOf(a)) throw new Error(a + " is not a valid noise sound");
            return {
      ...
      4: [
        function (a, b) {
          function c(a, b) {
            ...
            if (-1 === c.indexOf(a)) throw new Error(a + " is not a valid Oscillator type");
            return {
        ...
        function (a, b) {
          function c(a, b, c) {
            ...
            if (
              ...
              throw new Error(b + " is not a currently loaded Instrument Pack.");
            var f = this,
              g = 0,
              h = 1,
              i = 0.05;
                ...
                for (var b = f.notes.slice(g), c = 0; a > c; c++)
                  for (var d = -1; ++d < b.length; ) {
                    ...
                    (h.startTime = f.totalDuration),
                      (h.stopTime = f.totalDuration + h.duration - h.articulationGap),
                      f.notes.push(h),
      ...
      6: [
        function (a, b) {
          (b.exports = a("./conductor.js")),
            b.exports.loadPack("instrument", "noises", a("./instrument-packs/noises.js")),
            b.exports.loadPack("instrument", "oscillators", a("./instrument-packs/oscillators.js")),
            b.exports.loadPack("rhythm", "northAmerican", a("./rhythm-packs/north-american.js")),
            b.exports.loadPack("rhythm", "european", a("./rhythm-packs/european.js")),
            b.exports.loadPack(
              "tuning",
              "equalTemperament",
        ...
        function (a, b) {
          function c(a) {
            function b(b) {
              ...
              for (
                b && (d(), (l = a.percentageComplete * a.totalDuration)), c = -1;
                ++c < k.length;
            ...
            function c(b, c, d) {
              if (("undefined" == typeof d && (d = !1), "up" !== b && "down" !== b))
                throw new Error("Direction must be either up or down.");
              var e = 0.2;
              (m = "down" === b),
                "up" === b
                  ? (a.masterVolume.gain.linearRampToValueAtTime(0, a.audioContext.currentTime),
                  ...
                  : (a.masterVolume.gain.linearRampToValueAtTime(
                    ...
                    a.masterVolume.gain.linearRampToValueAtTime(0, a.audioContext.currentTime + e)),
                setTimeout(function () {
            ...
            function e() {
              for (var b = [], c = -1, d = a.noteBufferLength; ++c < a.instruments.length; ) {
                    ...
                    if (
                      ...
                      for (var o = -1; ++o < i.length; ) {
                        ...
                        b.push({
                          startTime: j,
                          stopTime: k,
                          node: e.instrument.createNote(n, a.pitches[p.trim()] || parseFloat(p)),
                          gain: n,
                          volumeLevel: m,
                        });
                      }
            ...
            d(),
              ...
              (j.muted = !1),
              (j.play = function () {
                (j.playing = !0), (j.paused = !1), (i = a.audioContext.currentTime), f();
                  ...
                  d = function (a) {
                    for (var c = -1; ++c < a.length; ) {
                      ...
                      d.tie ||
                        ...
                        d.gain.gain.linearRampToValueAtTime(d.volumeLevel, e + 0.001),
